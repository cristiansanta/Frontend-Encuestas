...
const ChildQuestionForm = forwardRef(({ parentQuestionData, formId, onSave, onCancel, isSaved = false, ...props }, ref) => {
  ...
  return (
    <div className="w-5/6 ml-auto"> {/* Contenedor que define el ancho */}
      ...
      <div className={`flex flex-col gap-4 ${isCollapsed ? 'py-2 px-6 h-15 overflow-hidden' : 'p-6'} rounded-xl bg-white shadow-2xl w-full transition-all duration-300 ease-in-out`} style={isCollapsed ? { minHeight: '50px' } : {}}>
