...
const SectionSelector = ({
  ...
  const isAcceptButtonEnabled = selectedSection !== null || (newSectionName.trim() !== '' && !inputError);
  ...
  return (
    <div className="relative">
      ...
      {isDropdownOpen && (
        <div
          ref={dropdownRef}
          className="absolute z-10 left-0 top-full mt-2 bg-white shadow-lg rounded-2xl p-4 w-[515px]"
        >
          ...
          <div className="relative mb-4">
            <input
              ...
              className={`w-full border ${inputError ? 'border-red-500' : isFocused ? 'border-dark-blue-custom' : 'border-gray-300'} rounded-full px-4 py-2 pr-10 outline-none text-sm transition-colors`}
            ...
            <button
              className={`absolute right-2 top-1/2 transform -translate-y-1/2 rounded-full p-1 ${newSectionName.trim() !== '' && !inputError ? 'text-dark-blue-custom' : 'text-gray-400'}`}
            ...
            {filteredSections.length === 0 ? (
              ...
              filteredSections.map((section) => (
                ...
                >
                  ...
                  <div
                    className={`w-5 h-5 border-2 border-dark-blue-custom rounded-full flex-shrink-0 mr-3
