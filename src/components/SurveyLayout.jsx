 ...
 * Extiende el MainLayout agregando la barra de progreso y botones de navegación contextuales
 * 
 * @param {Object} props - Propiedades del componente
 * @param {React.ReactNode} props.children - Contenido específico de la página
 * @param {string} props.currentView - Vista actual para la barra de progreso ('SurveyCreate', 'QuestionsCreate', 'PreviewSurvey')
...
const SurveyLayout = ({ 
  ...
  return (
    <MainLayout headerTitle={headerTitle}>
      ...
      <div className="mb-4">
        {showBackButton && <NavigationBackButton currentView={currentView} />}
      </div>
